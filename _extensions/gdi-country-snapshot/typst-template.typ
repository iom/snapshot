...
// Constants
#let product-title = "GDI Country Data Snapshot"
    ...
    grid(
      ...
      block(inset: 7pt)[
        ...
        #let citation = block[
          ...
          Cite as: International Organization for Migration, Global Data Institute. #date-ymd #text(style: "italic")[GDI Country Data Snapshot: #title.]
        ]
      ...
      #block[
        #pad(bottom: 3pt)[
          ...
          #block[
            ...
            This #text(weight: "bold")[Country Data Snapshot] is a brief overview of migration-related statistics from global datasets compiled by UN agencies and other international organisations.
          ]

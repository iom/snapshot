...
snap_plot("stocks_pt", code, basesize = basesize, font = font) |> 
...
snap_plot("nats_pt", code, basesize = basesize, font = font) |> 
...
snap_plot("migpyr_pt", code, basesize = basesize, font = font) |> 
...
cowplot::plot_grid(
  snap_plot("nmig_pt", code, basesize = basesize, font = font) |> 
    plot_label(i, h = .15 / 2.50),
  plot_nmigmap_pt(code, basesize = basesize, font = font) |> 
...
snap_plot("idp_pt", code, basesize = basesize, font = font) |> 
  plot_label(i, span = 1, h = .15 / 2.25)
i <- i + 1
```
...
cowplot::plot_grid(
  snap_plot("idpmap_pt", code, basesize = basesize, font = font) |> 
    plot_label(i, h = .15 / 2.75),
  snap_plot("idcause_pt", code, basesize = basesize, font = font) |> 
...
cowplot::plot_grid(
  snap_plot("mmp_pt", code, basesize = basesize, font = font) |> 
    plot_label(i, h = .15 / 2.50),
  snap_plot("mmpmap_pt", code, basesize = basesize, font = font) |> 
    plot_label(i + 1, h = .15 / 2.50)
)
i <- i + 2
```
